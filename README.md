...
Until `/loop-init` ships in Phase 2, scaffold your project's `.loop/` manually — run this once at your repo root:
...
- **Phase 1 — Memory** (this release): hooks, distill protocol, vault.
...
```bash
./tests/run.sh   # 24 cases: hook contracts, sanitization, edge cases
```
